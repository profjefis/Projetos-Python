...
quantNotas = [int(valor/100),int((valor%100)/50),int(((valor%100)%50)/20),int((((valor%100)%50)%20)/10),int(((((valor%100)%50)%20)%10)/5),int((((((valor%100)%50)%20)%10)%5)/2),int(((((((valor%100)%50)%20)%10)%5)%2)/1)]
def printnotas():
